...
$reponse = $db->query("SELECT * FROM articles where id_ar='$id1'");
while ($donnees = $reponse->fetch())
{ 
        $id_client=$donnees['id_client'];
}
$reponse2 = $db->query("SELECT * FROM clients where id_client='$id_client'");
while ($donnees2 = $reponse2->fetch())
{ 
        $nom=$donnees2['nom'];
        $email1=$donnees2['email'];
...
$mail->isHTML (true);
$mail->Subject = 'Demande de livraison';
...
<p style='margin: 0; font-size: 12px; text-align: center; mso-line-height-alt: 14.399999999999999px;'><span style='font-size:15px;'>Bonjour, Bienvenue parmi nous cher(e) $nom, votre compte a ete cree avec succes.
 ...
 <p style='margin: 0; font-size: 12px; text-align: center; mso-line-height-alt: 14.399999999999999px;'><span style='font-size:15px;'> <p>-L'ID de premier articles: $id1</p>
 <p>-L'ID de deuxième articles: $id2</p>
 <p>-Première adresse: $adresse1</p>
 <p>-Deuxième address: $adresse2</p>
 <p>-Votre message: $message</p></p>
...
$mail->send();
$reponse3 = $db->query("SELECT * FROM articles where id_ar='$id2'");
while ($donnees3 = $reponse3->fetch())
{ 
        $id_client2=$donnees3['id_client'];
}
$reponse4 = $db->query("SELECT * FROM clients where id_client='$id_client2'");
while ($donnees4 = $reponse4->fetch())
{ 
        $nom2=$donnees4['nom'];
        $email2=$donnees4['email'];
...
<div style='font-family: Tahoma, Verdana, sans-serif'>
<div class='' style='font-size: 12px; mso-line-height-alt: 14.399999999999999px; color: #010000; line-height: 1.2; font-family: 'Lato', Tahoma, Verdana, Segoe, sans-serif;'>
<p style='margin: 0; font-size: 12px; text-align: center; mso-line-height-alt: 14.399999999999999px;'><span style='font-size:15px;'>Bonjour, Bienvenue parmi nous cher(e) $nom2, votre compte a ete cree avec succes.
...
header("location: ../views/profil_client.php?error63=Votre demande de livraison a éte envoyez#livraison");
