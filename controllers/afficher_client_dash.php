...
<li>
    <a class="active" href="#">Espace Client</a>
</li>
</ul>
</div>
</div>
  ...
  <tbody>
    <?php
     ...
     { 
            ...
            <td>$Sexe</td>
            <td>$Adresse</td>
            <td><img src ='images/$Image' style='height: 50px;'></td>";   ?>  
            <td> 
            <button class="btn btn-danger"><a onclick="return confirm('êtes-vous sûr de vouloir supprimer?');" href ="delete_dash_client.php?effacerid=<?php echo $Id;?>" class ="text-light"><i class="bx bx-trash"></i></a></button>
            </td>
            </tr>
            <?php   }?>    
  </tbody>
