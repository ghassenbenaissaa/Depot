...
if (isset($_SESSION['IDD']) && isset($_SESSION['nom'])) {  //idha m3abyin
  ...
  $ID =$_SESSION['IDD'];
    ...
    $reponse = $db->query("SELECT * FROM administrateurs where id_ad=$id_ad");
    while ($donnees = $reponse->fetch())
    { 
            $email=$donnees['email_ad'];
            $nom=$donnees['nom_ad'];
            $mdp=$donnees['mdp_ad'];
    }
...
<li>
    <a class="active" href="#">Inscription Client</a>
</li>
</ul>
</div>
...
<form name="formulaire"  method="POST" >
        ...
        <tr>
                ...
                <td>
                <input class="form-control form-control-lg" type="email" id="email_ad"  name="email_ad" value="<?php echo $email; ?>"/>
            </td>
            </tr>
            ...
            <tr>
                ...
                <td> 
                <input class="form-control form-control-lg" type="text" id="nom_ad" name="nom_ad" value="<?php echo $nom; ?>" />
            </td>
            </tr>
