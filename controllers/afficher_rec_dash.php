...
<li>
    <a class="active" href="#">Espace Reclamation</a>
</li>
</ul>
</div>
</div>
...
<div class="order">
    <div class="head">
        <h3><u> Tableau des reclamations </u></h3>
  ...
  <tbody>
    <?php
    $reponse = $db->query("SELECT * FROM reclamations");
    ...
    <?php
            ...
            $id2=$donnees['id_ar'];
            $type=$donnees['td_re'];
            $message=$donnees['description_re'];
    ...
    <?php
            ...
            ';?>
            <td> 
            <button class="btn btn-danger"><a onclick="return confirm('êtes-vous sûr de vouloir supprimer?');" href ="delete_dash_reclamations.php?id_re=<?php echo $id;?>" class ="text-light"><i class="bx bx-trash"></i></a></button>
