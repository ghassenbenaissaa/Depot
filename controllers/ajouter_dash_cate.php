...
<title>Dashboard_categorie_ajout</title>
</head>
<body>
...
<section id="sidebar">
    ...
    <ul class="side-menu ">
        <li>
            <a href="#">
                <i class='bx bx-cog'></i>
           <span class="text"><strong>Paramètre</strong></span>
            </a>
        </li>
...
<form name="formulaire"  method="POST" >
        <table > 
            ...
            <tr>
                ...
                <td> 
                <input class="form-control form-control-lg" type="text" id="nom_c" name="nom_c"  />
            </td>
            </tr>
