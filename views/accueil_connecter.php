...
<head>
  ...
  <title>Dépot_accueil_connect</title>
...
<body>
  ...
  <header id="header" class="fixed-top d-flex align-items-cente">
    <div class="container-fluid container-xl d-flex align-items-center justify-content-lg-between">
      ...
      <a href="profil_client.php" class="book-a-table-btn scrollto d-none d-lg-flex"><?php echo $_SESSION['nom']; ?></a>
        ...
        <?php
          ...
          while ($cat = $rq->fetch())
          {
            ...
            <div class="col-lg-6 menu-item filter-starters" >
              <img src="../forms/accueil/img/menu/lobster-bisque.jpg" class="menu-img" alt="">
