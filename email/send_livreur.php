...
$mail->isHTML (true);
$mail->Subject = 'Felicitation livreur';
...
<p style='margin: 0; font-size: 12px; text-align: center; mso-line-height-alt: 14.399999999999999px;'><span style='font-size:15px;'>Bonjour, Bienvenue parmi nous cher(e) $nom, votre compte a ete cree avec succes.
 ...
 <p style='margin: 0; font-size: 12px; text-align: center; mso-line-height-alt: 14.399999999999999px;'><span style='font-size:15px;'>-Votre identifiant est:$id</p>
...
$mail->send();
 ...
 header ("location:../views/se_connecter.php?secc=Votre compte a été créé avec succès, vérifiez votre boîte mail!");
